...
def mp_biodata(request):
    ...
    if mp_id:
        mp = MP.objects.filter(mp_id=mp_id).select_related(
            ...
            'educations__major_subject', 'educations__group',
            'educations__institution', 'educations__board_affiliation',
            'educations__result_type', 'educations__division_result',
            'educations__class_result',
            'personal_travels__country', 'personal_travels__purpose',
            Prefetch('addresses',
