...
from .forms import (
    ...
    ReligionForm, ResultTypeForm, StandingCommitteeForm, SubCommitteeForm,
...
from .models import (
    ...
    Religion, ResultType, StandingCommittee, SubCommittee,
...
MASTER_GROUPS = [
    ...
    },
    {
        ...
        'subtitle_en': 'Standing committees, sub-committees & positions in one place',
        'entities': [
            ...
            {'key': 'sub-committee', 'model': SubCommittee, 'form': SubCommitteeForm,
             'title_bn': 'উপ-কমিটি', 'title_en': 'Sub-Committees', 'icon': 'bi-diagram-3',
             'hint_bn': 'উপ-কমিটি — একটি স্থায়ী কমিটির অধীনে।',
             'hint_en': 'Sub-committees under a standing committee.',
             'cols': [{'label_bn': 'স্থায়ী কমিটি', 'label_en': 'Standing Committee',
                       'attr': 'committee'}]},
